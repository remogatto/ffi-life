...
@grid_100 = Life.new(NativeGrid.new(@seed_100, 100))
@grid_60 = Life.new(NativeGrid.new(@seed_60, 60))
...
@grid_100 = Life.new(Grid.new(@seed_100, 100))
@grid_60 = Life.new(Grid.new(@seed_60, 60))
